...
import { decodeToken, generateAccessToken, generateRefreshToken, validateToken } from '../../../../config/authToken';
...
export const login = async (email: string, password: string): Promise<any> => {
  try {
    ...
    const accessToken = generateAccessToken(user.id, user.name, user.email, user.pixKey, user.phone, user.active, user.admin);
